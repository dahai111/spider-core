...
public class BaseDAO
{
	...
	{
		return sqlSession.selectOne(getSqlId());
	};
	...
	public void insertBatch(List<?> params)
	{
		...
		// }
		sqlSession.insert(getSqlId(),params);
	}
	...
	private String getSqlId()
	{
		...
		String sqlID = new StringBuffer(stack.getClassName()).append(".").append(stack.getMethodName()).toString();
		if(LOG.isDebugEnabled())
		{
			LOG.info("sql id :" + sqlID);
		}
